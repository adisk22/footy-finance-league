-- Set up user balances for existing users and ensure portfolio system is properly configured

-- Update existing users who don't have a balance to have a starting balance of €1000
UPDATE public.users 
SET balance = 1000 
...
-- Ensure portfolio table has proper constraints
...
-- Add a function to handle portfolio updates when buying/selling
...
-- Add unique constraint to portfolio to prevent duplicate entries
ALTER TABLE public.portfolio 
